...
[Activities/1-CSSTypography/README.md](Activities/1-CSSTypography/README.md)
...
* Walk students through the process of incorporating a Google Font. You can use the below steps as a guide.
  ...
  * Then open the file `html-template.html` (2-GoogleFontDemo > Unsolved) first in the browser and then in Sublime. Point out that its the same file they worked with just now.
...
[Activities/2-GoogleFontDemo/README.md](Activities/2-GoogleFontDemo/README.md)
...
[Activities/3-Pseudoclass/README.md](Activities/3-Pseudoclass/README.md)
...
* Tell them that this is Activity 4, optionally slack them the link to the [Activities/4-WheresCSS/bootstrap-powered.html](Activities/4-WheresCSS/bootstrap-powered.html) file or the file itself (for convenience)
...
[Activities/5-BootstrapDemo/README.md](Activities/5-BootstrapDemo/README.md)
